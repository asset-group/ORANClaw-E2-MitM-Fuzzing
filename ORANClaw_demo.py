...
class SCTPMITMProxy:
    ...
    def __init__(self, mitm_ip=IP_MITM, xapp_ip=IP_XAPP, ric_ip=IP_RIC, port=PORT):
        ...
        self.fuzzer.strategy_optimizer = None # self.strategy_optimizer
        # Fuzzing statistics
...
def restart_container_periodically(container_name, interval_sec=15):
    ...
    try:
        ...
        print(Fore.RED + f"[Error] Container '{container_name}' not found.")
    except Exception as e:
...
def main():
    ...
    # Start the Docker container restart in a background thread
    threading.Thread(
    ...
    # Initialize and start the MITM proxy
