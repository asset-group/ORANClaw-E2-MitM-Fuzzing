...
int main (int argc, char** argv)
{
   ...
   ASN1T_ProtocolIE_ContainerPair encdata;
   ASN1C_ProtocolIE_ContainerPair encoder (encbuf, encdata);

   // Set up decoding objects

   OSRTSocketInputStream sockistrm (socket);
   ASN1PERDecodeBuffer decbuf (sockistrm , aligned);
   ASN1T_ProtocolIE_ContainerPair decdata;
   ASN1C_ProtocolIE_ContainerPair decoder (decbuf, decdata);
