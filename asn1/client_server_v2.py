...
constraints_file = "./constraints_output.json" 
...
class SCTPMITMProxy:
                        ...
                        for definition in definitions:
                            try:
                                ...
                                if decoded_json:
                                    ...
                                    modified_json = self.mutate_field(decoded_json, constraints, "measLabel")
    ...
    def hex_to_json(self, hex_data):
        ...
        try:
            reader_command = ['./reader', '-hex', str(hex_data)]
    ...
    def json_to_hex(self, json_data):
        ...
        try:
            ...
            try:
                reader_json_command = ['./reader_json', '-json', temp_file_path]
