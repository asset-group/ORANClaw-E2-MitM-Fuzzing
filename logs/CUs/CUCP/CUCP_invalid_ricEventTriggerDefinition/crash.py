...
target_keys = ['ricEventTriggerDefinition']
...
class JsonFuzzer:
    ...
    def mutate_json(self, json_data, message_type=None, mutation_probability=1, max_mutations=1):
        """
        ...
        priority_fields = {
            ...
            "RICsubscription": ["ricEventTriggerDefinition"],
    ...
    def process_message(self, msg, direction="to_ric"):
        ...
        try:
            ...
            if direction == "to_ric":
                ...
                print("Mutated JSON:", json.dumps(fuzzed_json, indent=2))
...
class SCTPMITMProxy:
    ...
    def __init__(self, mitm_ip=IP_MITM, xapp_ip=IP_XAPP, ric_ip=IP_RIC, port=PORT):
        ...
        self.fuzz_probability =1  # 70% chance to fuzz each message
